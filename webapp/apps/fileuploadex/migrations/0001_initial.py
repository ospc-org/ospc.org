# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2018-08-23 21:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inputs', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='outputs', to='fileuploadex.FileInput')),
