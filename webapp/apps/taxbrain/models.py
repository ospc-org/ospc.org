...
class TaxSaveInputs(models.Model):
    ...
    ID_BenefitSurtax_Switch_6 = models.CharField(default=None, blank=True, null=True, max_length=50)
    ID_BenefitCap_rt = CommaSeparatedField(default=None, blank=True, null=True)
    ID_BenefitCap_Switch_0 = models.CharField(default=None, blank=True, null=True, max_length=50)
    ID_BenefitCap_Switch_1 = models.CharField(default=None, blank=True, null=True, max_length=50)
    ID_BenefitCap_Switch_2 = models.CharField(default=None, blank=True, null=True, max_length=50)
    ID_BenefitCap_Switch_3 = models.CharField(default=None, blank=True, null=True, max_length=50)
    ID_BenefitCap_Switch_4 = models.CharField(default=None, blank=True, null=True, max_length=50)
    ID_BenefitCap_Switch_5 = models.CharField(default=None, blank=True, null=True, max_length=50)
    ID_BenefitCap_Switch_6 = models.CharField(default=None, blank=True, null=True, max_length=50)
